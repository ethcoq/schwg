...
#endif
#ifndef MLKEM_PRIVATE_KEY_LEN
#define MLKEM_PRIVATE_KEY_LEN 2400
#endif
#ifndef MLKEM_PUBLIC_KEY_LEN
#define MLKEM_PUBLIC_KEY_LEN 1184
#endif
#ifndef MLKEM_PUBLIC_KEY_B64
#define MLKEM_PUBLIC_KEY_B64 1581
#endif
#ifndef MLKEM_PRIVATE_KEY_B64
#define MLKEM_PRIVATE_KEY_B64 3201
#endif
...
enum {
	...
	WGPEER_HAS_MLKEM_PUBLIC_KEY = 1U << 5
};
...
struct wgpeer {
	...
	uint8_t mlkem_public_key[MLKEM_PUBLIC_KEY_LEN];
...
enum {
	...
	WGDEVICE_HAS_MLKEM_PRIVATE_KEY = 1U << 5,
	WGDEVICE_HAS_MLKEM_PUBLIC_KEY = 1U << 6
};
...
struct wgdevice {
	...
	uint8_t mlkem_public_key[MLKEM_PUBLIC_KEY_LEN];
	uint8_t mlkem_private_key[MLKEM_PRIVATE_KEY_LEN];
